...
public class Order implements Serializable {
    ...
    public static final int STATUS_NHANDH = 1;
    public static final int STATUS_CBIDH = 2;
    public static final int STATUS_GIAODH = 3;
    public static final int STATUS_GIAODHTC = 4;
    public static final int STATUS_HOANTHANH = 5;
